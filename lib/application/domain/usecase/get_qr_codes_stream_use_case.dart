...
class GetQrCodesStreamUseCase extends StreamUseCaseNoParams<List<QrCodeEntity>> {
  GetQrCodesStreamUseCase(this._qrCodeRepository);

  final QrCodeRepository _qrCodeRepository;

  @override
  StreamSubscription<List<QrCodeEntity>> listen(
    final void Function(List<QrCodeEntity> event)? onData, {
