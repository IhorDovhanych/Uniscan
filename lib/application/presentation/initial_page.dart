...
class InitialPage extends StatelessWidget {
  ...
  @override
  Widget build(final BuildContext context) => BlocListener<AuthCubit, UserEntity?>(
        listenWhen: (final prev, final next) =>
            (prev == null && next != null) || (prev != null && next == null) || (prev?.id != next?.id),
        listener: (final context, final state) {
          final router = AutoRouter.innerRouterOf(context, InitialRoute.name) ?? context.router;
          if (state != null) {
